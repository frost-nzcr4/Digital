...
namespace Survival_on_island
{
    public partial class Island : Form
    {
        ...
        Items WoodAxe = new Items("Деревянный топор", "Самый простой и непрочный топор.\nС таким много не нарубишь.\nСбор древесины: +0-1", 0, 1, 4);
        Items RockAxe = new Items("Каменный топор", "Самый лучший топор, что можно сделать в этих условиях.\nСбор древесины: +1-2", 0, 1, 4);
