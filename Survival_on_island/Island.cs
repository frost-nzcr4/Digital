...
namespace Survival_on_island
{
    public partial class Island : Form
    {
        ...
        Items Lance = new Items("Копье", "Хороший инструмент для охоты на дичь.", 0, 1);
        Items Baton = new Items("Дубинка", "Сгодится для охоты. Особенно хороша против крупных зверей.", 0, 1);
            //вспомогательные
